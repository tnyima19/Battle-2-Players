...
I am also planning to automate one of the players so that the player fights against the computer instead of another human.I will be using random patters, for the computer, so that computer is not predictable on what it is going to do(attack or defend).(DONE )
...
Put ability called agility: this would increase the chance to dodge attacks.
Graphics using Unreal Engine. 
